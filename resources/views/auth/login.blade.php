      ...
      <div class="login-area">
        ...
        <form method="POST" action="{{ route('login_action') }}">
          ...
          <div class="email-area">
            ...
            <input type="email" name="email" placeholder="Digite o seu e-mail" value="{{ $email ?? ''}}" required/>
            @error('email')
        ...
        @enderror
          ...
          <div class="password-area">
            <div class="password-label">
              ...
              <a href="{{ 'forgot-password' }}" class="password-area-forgot">Esqueceu sua senha?</a>
            </div>
            <x-forms.password-input name="password" placeholder="digite sua senha" id="password" required/>
            @error('password')
            <div class="error">{{ $message }}</div>
        @enderror
          </div>
