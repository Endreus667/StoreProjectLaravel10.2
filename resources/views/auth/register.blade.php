        ...
        <div class="login-area">
            ...
            <form method="POST" action="{{ route('register_action') }}">
                ...
                <div class="password-area">
                    ...
                    <x-forms.password-input name="password" placeholder="digite sua senha" id="confimeSenha"/>
                    @error('password')
                        <div class="error">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="password-area">
                    <div class="password-label">Confirme a sua senha</div>
                    <x-forms.password-input name="password_confirmation" placeholder="confirme sua senha" id="confimeSenha_confirmation"/>
